# ATELIER  : Builds Avancés et Parallélisation (45min)

## Objectif
Créer un pipeline avec des builds paramétrés, parallélisés et distribués.

## Étapes

1. **Pipeline Multi-Paramètres**
```groovy
pipeline {
    agent any
...
- Lancer le build avec différents paramètres
- Observer l'exécution parallèle
